...
import { BUSINESS_EMAIL, LOAN_LIMITS, SITE_NAME } from "@/src/lib/constants";
            ...
            <div className="space-y-8 text-text-secondary leading-relaxed">
              <div className="bg-primary/5 border border-primary/20 rounded-xl p-6">
                ...
                <p className="text-text-primary font-medium">
                  ...
                  loan marketplace, lead generator, or aggregator. When you
                  apply with {SITE_NAME}, your application is reviewed and
                  processed entirely by us.
                </p>
              </div>
                  ...
                  {[
                    {
                      ...
                      description:
                        "Your application is reviewed only by Flexi Lend. We do not sell or share your application with other lenders.",
                    },
                    {
              ...
              <div>
                ...
                <p>
                  {SITE_NAME} is licensed to lend in the states where it
                  operates. Our NMLS number is XXXXXXX. You can verify our
                  licensing status through the NMLS Consumer Access website.
                </p>
              </div>
