...
import { BUSINESS_EMAIL, SITE_NAME } from "@/src/lib/constants";
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="space-y-8 text-text-secondary leading-relaxed">
              ...
              <div>
                ...
                <p className="mb-4">
                  We comply with all applicable fair lending laws and
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    <strong>Fair Housing Act:</strong> Prohibits discrimination
                    in residential real estate-related transactions.
                  </li>
                  <li>
                    <strong>Community Reinvestment Act (CRA):</strong>{" "}
                    Encourages financial institutions to meet the credit needs
                    of all communities they serve.
                  </li>
                  <li>
                    <strong>Home Mortgage Disclosure Act (HMDA):</strong>{" "}
                    Requires collection and reporting of lending data.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-3">
                  <li>
                    <strong>Objective Criteria:</strong> All lending decisions
                    are based on objective, credit-related factors including
                    credit history, income, employment stability, and
                  ...
                  <li>
                    <strong>Transparent Terms:</strong> All loan terms, rates,
                    and fees are clearly disclosed before you accept an offer.
                  </li>
                  <li>
                    <strong>Responsible Lending:</strong> We assess each
                    borrower&apos;s ability to repay and do not make loans that
                    we believe a borrower cannot reasonably repay.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  connection with a credit transaction, you may file a complaint
                  with:
                </p>
