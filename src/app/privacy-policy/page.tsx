            ...
            <div className="space-y-8 text-text-secondary leading-relaxed">
              <div>
                ...
                <p>
                  ...
                  at {SITE_URL} and use our lending services. This policy
                  complies with the Gramm-Leach-Bliley Act (GLBA) and applicable
                  state privacy laws.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  notice of our information-sharing practices. We do not sell
                  your personal financial information to third parties for
                  marketing purposes. We may share your information with:
                </p>
                <ul className="list-disc pl-6 space-y-2 mt-3">
                  <li>Credit bureaus to verify creditworthiness</li>
                  <li>
                    Service providers who assist in loan processing and
                    servicing
                  </li>
                ...
                <p className="mt-3">
                  ...
                  To exercise your opt-out rights, contact us at{" "}
                  {BUSINESS_EMAIL}.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  agreements. Loan records are retained for a minimum of 7 years
              ...
              <div>
                ...
                <p>
                  ...
                  your browsing experience and collect analytics data. These
                  include:
                </p>
                <ul className="list-disc pl-6 space-y-2 mt-3">
                  <li>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2 mt-3">
                  ...
                  <li>
                    Right to delete your personal data (subject to legal
