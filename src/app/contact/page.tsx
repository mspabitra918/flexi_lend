...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    {
      title: "Office",
      value: "355 S Grand Ave, Office #2 W Los Angeles, CA 90071",
      desc: "California-Based Support",
                ...
                <div className="p-10 lg:p-14">
                  {submitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <button
                        type="submit"
                        className="w-full bg-primary hover:bg-primary-dark text-white font-bold py-4 rounded-xl transition-all hover:shadow-lg"
                      >
                        Send Message
                      </button>
                    </form>
